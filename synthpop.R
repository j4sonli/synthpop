...
hh_pool_file <- paste0("synthpop_output/hh_pool_", pumas, output_suffix, ".csv")
indv_pool_file <- paste0("synthpop_output/indv_pool_", pumas, output_suffix, ".csv")
...
tract_block_equiv_file <- paste0("synthpop_data/tract_block_equivs/COL2010_TAB2010_ST_", substr(pumas,0,2),
                                 "_v2/COL2010_TAB2010_ST_", substr(pumas,0,2), "_v2.txt")
